...
(function (MovieTutorial) {
    ...
    (function (Default) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Default.Gender');
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        ...
        (function (MovieCastRow) {
            ...
            ['MovieCastId', 'MovieId', 'PersonId', 'Character', 'MovieTitle', 'MovieDescription', 'MovieStoryline', 'MovieYear', 'MovieReleaseDate', 'MovieRuntime', 'MovieKind', 'PersonFirstname', 'PersonLastname', 'PersonBirthDate', 'PersonBirthPlace', 'PersonGender', 'PersonHeight', 'PersonFullname'].forEach(function (x) { return Fields[x] = x; });
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        ...
        Serenity.Decorators.registerEnum(MovieKind, 'Default.MovieKind');
    })(Default = MovieTutorial.Default || (MovieTutorial.Default = {}));
})(MovieTutorial || (MovieTutorial = {}));
var MovieTutorial;
(function (MovieTutorial) {
...
(function (MovieTutorial) {
    ...
    (function (Default) {
        ...
        (function (PersonRow) {
            ...
            ['PersonId', 'Firstname', 'Lastname', 'BirthDate', 'BirthPlace', 'Gender', 'Height', 'Fullname', 'PrimaryImage', 'GalleryImages'].forEach(function (x) { return Fields[x] = x; });
    ...
    (function (Default) {
        var MovieGrid = (function (_super) {
            ...
            MovieGrid.prototype.getQuickSearchFields = function () {
                var fld = Default.MovieRow.Fields;
                var txt = function (s) { return Q.text("Db." +
                    Default.MovieRow.localTextPrefix + "." + s).toLowerCase(); };
                return [
                    { name: "", title: "all" },
